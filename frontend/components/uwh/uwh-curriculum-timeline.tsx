        ...
        <div className="flex items-center gap-3 overflow-x-auto pb-1">
          {CURRICULUM_DAYS.map((day, i) => (
            <div key={day.day} className="flex items-center">
              <div
                className="flex min-w-[130px] flex-col items-center rounded-xl border px-5 py-4 transition-all hover:-translate-y-0.5"
                style={{
              ...
              >
                ...
                <span className="mt-1 text-center text-[11px] text-[#9CA3AF]">
                  {day.label.split(": ")[1]}
                </span>
              </div>
              {i < CURRICULUM_DAYS.length - 1 && (
                <div className="mx-2 h-[2px] w-8 bg-[#E5E7EB]" />
              )}
            </div>
          ))}
        </div>
