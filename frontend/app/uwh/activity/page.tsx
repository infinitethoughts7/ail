...
const TYPE_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  submission_verified: { bg: "bg-[#059669]/5", text: "text-[#059669]", border: "border-[#059669]/15" },
  photo_approved: { bg: "bg-[#2563EB]/5", text: "text-[#2563EB]", border: "border-[#2563EB]/15" },
  project_approved: { bg: "bg-[#7C3AED]/5", text: "text-[#7C3AED]", border: "border-[#7C3AED]/15" },
